...
public class ExportService {
    ...
    public byte[] exportEntriesToPdf(List<PaymentEntryDTO.Response> entries, LocalDate from, LocalDate to)
        ...
        String toStr   = to   != null ? to.toString()   : IstClock.today().toString();
        ...
        Paragraph footer = new Paragraph(
                "Generated by PayTrack on " + IstClock.today() + "   |   Total records: " + entries.size(),
                footerFont);
    ...
    public byte[] exportPartyLedgerToPdf(PartyLedgerDTO.Response ledger, List<PartyLedgerDTO.Entry> entries,
        ...
        Paragraph footer = new Paragraph(
                "Generated by PayTrack on " + IstClock.today() + "   |   Party: " + ledger.getDisplayName(),
                footerFont);
        footer.setAlignment(Element.ALIGN_RIGHT);
        footer.setSpacingBefore(14);
        doc.add(footer);
